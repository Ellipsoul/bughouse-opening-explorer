#!/usr/bin/env python3
"""Export a checked king-height insight projection as deterministic JSON."""
...
from bughouse_explorer.insights.export import export_king_height_insights
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export one immutable king-height insight for the web client."
    )
    ...
    report = export_king_height_insights(database, output, replace=args.replace)
    payload = {
        **asdict(report),
