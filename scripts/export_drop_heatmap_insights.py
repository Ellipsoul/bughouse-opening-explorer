#!/usr/bin/env python3
"""Export a checked piece-drop heat-map projection as deterministic JSON."""
...
from bughouse_explorer.insights.export import export_drop_heatmap_insights
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export one immutable piece-drop heat map for the web client."
    )
    ...
    report = export_drop_heatmap_insights(database, output, replace=args.replace)
    payload = {
        **asdict(report),
