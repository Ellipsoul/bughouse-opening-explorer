#!/usr/bin/env python3
"""Export a checked player-insights database as deterministic static JSON."""
...
from bughouse_explorer.insights.export import export_material_insights
...
def main() -> None:
    parser = argparse.ArgumentParser(
        description="Export one immutable material-insights database for the web client."
    )
    ...
    report = export_material_insights(database, output, replace=args.replace)
    payload = {
        **asdict(report),
